...
{
	// Source = 이 이펙트의 발의자, Target = 이펙트의 타겟 (이 AttributeSet의 소유자)
	Props.EffectContectHande = Data.EffectSpec.GetContext();
	Props.SourceASC = Props.EffectContectHande.GetOriginalInstigatorAbilitySystemComponent();
